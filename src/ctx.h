...
SPN_API int		  spn_ctx_loadobjdata(SpnContext *ctx, const void *objdata, size_t objsize, SpnValue *result);
...
SPN_API int		  spn_ctx_compile_expr(SpnContext *ctx, const char *expr, SpnValue *result);
